...
export function DoctorPersonalInfoForm() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
      ...
      <div>
        <label htmlFor="dob" className="block text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
          Date of Birth
        </label>
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2.5 sm:px-4 sm:py-3 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#00AAEE] focus:border-[#00AAEE] transition-colors pr-10 text-sm sm:text-base"
          />
      ...
      <div>
        <label htmlFor="gender" className="block text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
          Gender
        </label>
        <div className="relative">
          <select
      ...
      <div>
        <label htmlFor="address" className="block text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
          Address
        </label>
        <input
          id="address"
      ...
      <div>
        <label htmlFor="nationality" className="block text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
          Nationality
        </label>
        <div className="relative">
          <select
      ...
      <div>
        <label htmlFor="language" className="block text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">
          Preferred Language
        </label>
        <div className="relative">
          <select
